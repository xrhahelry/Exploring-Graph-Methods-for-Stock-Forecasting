...
def main(model_type):
    # Load the data
    data_path = "../data/fundamental data/commercial bank/NMB.csv"
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    model_path = "models/gcn(nmb).pth" if model_type == 'GCN' else "models/gat(nmb).pth"
...
if __name__ == "__main__":
    raise ValueError("Model type must be specified when running this script.")