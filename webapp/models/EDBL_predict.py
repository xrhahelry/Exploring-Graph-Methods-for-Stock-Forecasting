...
# Load the scaler
scaler = joblib.load('../GNN/scalers/db_edbl.pkl')
...
def main(model_type):
    ...
    test_graphs_path = "../GNN/graphs/test_graphs/db_edbl_test.pt"
    test_graphs = torch.load(test_graphs_path)

    # Load the data
    data_path = "../data/fundamental data/developement bank/EDBL.csv"
    ...
    model_path = "../GNN/models/gcn_edbl.pth" if model_type == 'GCN' else '../GNN/models/gat_edbl.pth'
