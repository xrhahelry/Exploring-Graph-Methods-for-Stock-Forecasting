...
# Load the scaler
scaler = joblib.load('../GNN/scalers/lf_alicl.pkl')
...
def main(model_type):
    ...
    test_graphs_path = "../GNN/graphs/test_graphs/lf_alicl_test.pt"
    test_graphs = torch.load(test_graphs_path)

    # Load the data
    data_path = "../data/fundamental data/life insurance/ALICL.csv"
