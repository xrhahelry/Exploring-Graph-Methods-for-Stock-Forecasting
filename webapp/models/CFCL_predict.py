...
# Load the scaler
scaler = joblib.load('../GNN/scalers/f_cfcl.pkl')
...
def main(model_type):
    ...
    test_graphs_path = "../GNN/graphs/test_graphs/f_cfcl_test.pt"
    test_graphs = torch.load(test_graphs_path)

    # Load the data
    data_path = "../data/fundamental data/finance/CFCL.csv"
    ...
    model_path = "../GNN/models/gcn_cfcl.pth" if model_type == 'GCN' else '../GNN/models/gat_cfcl.pth'
